...
risk_analysis_narrative_agent = Agent(
    ...
    tools=[YFinanceTools(key_financial_ratios = True, stock_fundamentals = True, get_company_news = True, get_historical_stock_prices = True, get_company_info = True)], #add ml tool also
    # run_id=run_id,
    # user_id=user,
    knowledge=knowledge_base,
    instructions="""Based on the context provided to you, generate a comprehensive credit narrative addressing the users query. Use only the last 10 days stock prices.
